...
const devOnly = (schema, devDefault) => (isProd && !isBuild) ? schema : schema.default(devDefault);
const envSchema = z.object({
    ...
    SESSION_SECRET: devOnly(z.string().min(32, 'SESSION_SECRET must be at least 32 chars in production'), 'a9f3c2e1b8d74f6a0e5c9b2d1f4a7e3c8b5d2f9a6e1c4b7d0f3a8e5c2b9d6f1'),
