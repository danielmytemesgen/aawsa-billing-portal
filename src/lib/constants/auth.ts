...
export const PERMISSIONS = {
    ...
    // Global report permissions
    REPORT_CUSTOMER_DATA_EXPORT: 'report:customer_data_export',
    REPORT_BULK_METER_DATA_EXPORT: 'report:bulk_meter_data_export',
    ...
    REPORT_TARIFFS_DATA_EXPORT: 'report:tariffs_data_export',
    ...
    REPORT_BRANCH_BULK_METER_DATA_EXPORT: 'report:branch_bulk_meter_data_export',
    ...
    REPORT_BRANCH_TARIFFS_DATA_EXPORT: 'report:branch_tariffs_data_export',
    REPORT_BRANCH_STAFF_DATA_EXPORT: 'report:branch_staff_data_export',
    REPORT_BRANCH_GL_FINANCE_MONTHLY: 'report:branch_gl_finance_monthly',
    REPORT_BRANCH_GL_FINANCE_YEARLY: 'report:branch_gl_finance_yearly',
    REPORT_BRANCH_MONTHLY_BILL_EXPORT: 'report:branch_monthly_bill_export',
