...
import { baseBulkMeterDataSchema, meterSizeOptions, subCityOptions, woredaOptions } from "@/app/(dashboard)/admin/data-entry/customer-data-entry-types";
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 py-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Reading Route</FormLabel>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {routes.map((route: Route) => (
                          <SelectItem key={route.routeKey} value={route.routeKey}>
                            {route.routeKey} {route.description ? `(${route.description})` : ""}
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
